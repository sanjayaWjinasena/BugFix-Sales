...
class SaleOrderLine(models.Model):
    ...
    x_studio_product_status = fields.Selection([('Blank', 'Blank'), ('New Item', 'New Item'), ('Existing Item', 'Existing Item')], string='Product Status', readonly=True, store=False)
    ...
    x_studio_purch_type = fields.Selection([('Local', 'Local'), ('Import', 'Import')], string='Purch. Type')
